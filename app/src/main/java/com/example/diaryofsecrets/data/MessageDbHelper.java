...
public class MessageDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_DIARY_TABLE =  "CREATE TABLE " + MessageEntry.TABLE_NAME + " ("
                + MessageEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + MessageEntry.COLUMN_MESSAGE_DATE + " TEXT NOT NULL, "
                + MessageEntry.COLUMN_MESSAGE_TITLE + " TEXT NOT NULL, "
